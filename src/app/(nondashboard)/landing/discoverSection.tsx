      ...
      <div className="max-w-6xl xl:max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        ...
        >
            ...
            <p className="mt-4 text-lg text-gray-600">
                Find your Dream Rental Property with Ease!
            </p>
          ...
          {[
            {
                ...
                description: "Browse through our extensive collection of rental properties in your area.",
            },
            {
                imageSrc: "/landing-icon-calendar.png",
                title: "Book Your Rental",
                description: "Once you've found the perfect rental property, easily book it online with just a few cliks.",
            },
            {
                imageSrc: "/landing-icon-heart.png",
                title: "Enjoy your Rental Home",
